...
class axi_env extends uvm_env;
  ...
  virtual axi_abstract_if #(32) mst_abs_vif;
  virtual axi_abstract_if #(32) slv_abs_vif;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(virtual axi_abstract_if#(32))::get(this, "", "mst_abs_vif", mst_abs_vif)) begin
      `uvm_fatal("NO_MST_ABS_VIF", "axi_env: mst_abs_vif is not set")
    end
    if (!uvm_config_db#(virtual axi_abstract_if#(32))::get(this, "", "slv_abs_vif", slv_abs_vif)) begin
      `uvm_fatal("NO_SLV_ABS_VIF", "axi_env: slv_abs_vif is not set")
    end
    ...
    mst_cfg.vif = mst_vif;
    mst_cfg.vif_lite = mst_vif;
    mst_cfg.vif_abstract = mst_abs_vif;
    mst_cfg.if_kind = AXI_IF_KIND_LITE;
    mst_cfg.is_master = 1'b1;
    mst_cfg.is_active = UVM_ACTIVE;

    slv_cfg.vif = slv_vif;
    slv_cfg.vif_lite = slv_vif;
    slv_cfg.vif_abstract = slv_abs_vif;
    slv_cfg.if_kind = AXI_IF_KIND_LITE;
