...
# # ChipKit Serial
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_o }]; #IO_L10N_T1_34 Sch=CK_MISO
...
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { uart_rx_i   }]; #IO_L6P_T0_35  Sch=CK_SS
